                        ...
                        <Grid>
                            <Grid.Row columns={2}>
                                <Grid.Column>
                                    ...
                                    <p className="text-white">
                                        Click the query examples below  to select it or write you own query on the right.
                                    </p>
                            ...
                            <Grid.Row columns={1}>
                                ...
                                <h2 className="text-white">3. Check your results. <span>Pick a <b className="text-green">job ID</b> and see if BTE is done with your request.</span></h2>
                                    <p className="text-white"><b className="text-yellow" data-tippy-content="The response's <code>state</code> field value indicates the current status: <b>queued, active, completed.</b> "><i aria-hidden="true" className="info circle icon"></i> Checking your job status</b>: (<b className="text-green" data-tippy-content="The return value's <code>response</code> field holds BTE's response, which follows the Translator consortium's <a target='_blank' rel='noopener noreferrer' href='https://github.com/NCATSTranslator/ReasonerAPI'>TRAPI standards</a>. The answers are in the results section and are represented as graphs that fill in the info we'd like to know in the query."><i aria-hidden="true" className="info circle icon"></i>complete</b>, 
                                    <b className="text-green" data-tippy-content="BTE is currently working on your request! Your results shoud be ready soon 🎉"><i aria-hidden="true" className="info circle icon"></i>active</b>,
                                    <b className="text-green" data-tippy-content="BTE is experiencing a large number of requests at this time but your job will still be processed as soon as there's bandwith to process it"><i aria-hidden="true" className="info circle icon"></i>queued</b>). <Link to='/usage'>Learn more about how BTE processes queries.</Link></p>
